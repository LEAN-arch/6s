        ...
        with phase_tabs[2]:
            ...
            with st.expander("##### 📖 Explore Analyze Phase Tollgate Documents & Tools"):
                ...
                with doc_tabs[2]:
                    ...
                    X = regression_data['X']
                    y = regression_data.get('y', 0.5 * X + np.random.randn(50) * 2 + 3)
                    try:
        ...
        with phase_tabs[3]:
            ...
            with st.expander("##### 📖 Explore Improve Phase Tollgate Documents & Tools"):
                ...
                with doc_tabs[0]:
                    ...
                    try:
                        st.dataframe(pugh_df.style.applymap(lambda x: 'background-color: #90ee90' if x > 0 else 'background-color: #ffcccb' if x < 0 else ''))
